---
layout: post
title: 05-VIP-垃圾收集器ParNew&CMS与底层三色标记算法详解
tags: jvm
category: Java
date: 2022-12-16 14:58 +0800
---
...
![image-20221216151742950](https://s2.loli.net/2022/12/16/xT1iQbX4oFq9Ia6.png)**分代收集理论**
...
![image-20221216151848332](https://s2.loli.net/2022/12/16/zPQjlWdJZxSDYEr.png)
...
![image-20221216151916338](https://s2.loli.net/2022/12/16/NKpJLE8al19uGRy.png)

**标记-整理算法**

根据老年代的特点特出的一种标记算法，标记过程仍然与“标记-清除”算法一样，但后续步骤不是直接对可回收对象回收，而是让所有存活的对象向一端移动，然后直接清理掉端边界以外的内存。

![image-20221216151938142](https://s2.loli.net/2022/12/16/ansNRv1SWKMIfog.png)

**垃圾收集器**

------

![image-20221216152008625](https://s2.loli.net/2022/12/16/1t2LoSyjmgxBhD8.png)**如果说收集算法是内存回收的方法论，那么垃圾收集器就是内存回收的具体实现。**
...
![image-20221216152042448](https://s2.loli.net/2022/12/16/qWdUv5EsoAPhVcJ.png)
...
![image-20221216152108208](https://s2.loli.net/2022/12/16/9SkTxPMyi8Bw1V2.png)
...
![image-20221216152129698](https://s2.loli.net/2022/12/16/9SkTxPMyi8Bw1V2.png)
...
![image-20221216152149804](https://s2.loli.net/2022/12/16/mZwphTMGVn7RvOr.png)
...
![image-20221216152216934](https://s2.loli.net/2022/12/16/HC8LyV2ZpdMxTNX.png)
...
![image-20221216152250267](https://s2.loli.net/2022/12/16/qpNnV4oYCPeMiEB.png)
...
![image-20221216152317186](https://s2.loli.net/2022/12/16/2HLE814XczTWIfN.png)
...
![image-20221216152346269](https://s2.loli.net/2022/12/16/Qh2eKrqw5EVJzkF.png)
...
**文档：05-VIP-垃圾收集器ParNew&CMS与底层三色标记算法详解**

```
http://note.youdao.com/noteshare?id=21b50d8595b245f7d7d01a6bbfefe6c4&sub=899E33A5A1E340AABF57F7484EA58FFA
```
